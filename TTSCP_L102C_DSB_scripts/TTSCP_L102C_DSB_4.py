...
prmtop = AmberPrmtopFile('TTSCP_L102C_DSB_energyminimized.prmtop')
inpcrd = AmberInpcrdFile('TTSCP_L102C_DSB_energyminimized.inpcrd')
...
simulation.reporters.append(DCDReporter('TTSCP_L102C_DSB_rep4_200ns.dcd', LOG_FREQUENCY_STEPS))
...
simulation.reporters.append(
    StateDataReporter(
        'TTSCP_L102C_DSB_rep4_200ns.txt',
        LOG_FREQUENCY_STEPS,
        step=True,
        totalSteps=TOTAL_STEPS,
        potentialEnergy=True,
...
simulation.reporters.append(CheckpointReporter('TTSCP_L102C_DSB_rep4_200ns.chk', 5000))
