...
prmtop = AmberPrmtopFile('TTSCP_L102C_DSB_preenergyminimization.prmtop')
inpcrd = AmberInpcrdFile('TTSCP_L102C_DSB_preenergyminimization.inpcrd')
...
simulation.reporters.append(DCDReporter('TTSCP_L102C_DSB_energyminimization.dcd', LOG_FREQUENCY_STEPS))
...
simulation.reporters.append(
    StateDataReporter(
        'TTSCP_L102C_DSB_energyminimization.txt',
        LOG_FREQUENCY_STEPS,
        step=True,
        totalSteps=TOTAL_STEPS,
        potentialEnergy=True,
...
simulation.reporters.append(CheckpointReporter('TTSCP_L102C_DSB_energyminimization.chk', 5000))
